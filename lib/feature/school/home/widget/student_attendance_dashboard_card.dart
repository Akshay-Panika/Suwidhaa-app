...
class StudentAttendanceDashboardCard extends StatefulWidget {
  const StudentAttendanceDashboardCard({super.key});

  @override
  State<StudentAttendanceDashboardCard> createState() =>
      _StudentAttendanceDashboardCardState();
}

class _StudentAttendanceDashboardCardState
    extends State<StudentAttendanceDashboardCard>
