// lib/feature/school/student_list/model/student_list_model.dart
...
class StudentListResponse {
  final bool success;
  final int count;
  final List<StudentListData> data;
  ...
  factory StudentListResponse.fromJson(Map<String, dynamic> json) {
    return StudentListResponse(
      ...
      count: json['count'] ?? 0,
      data: json['data'] != null
          ? List<StudentListData>.from(json['data'].map((x) => StudentListData.fromJson(x)))
          : [],
    );
  }
}
...
class StudentListData {
  ...
  Color get statusColor {
    return feeStatus.toLowerCase() == 'paid' ? Colors.green : Colors.orange;
  }

  // Helper method to get status icon
  IconData get statusIcon {
    return feeStatus.toLowerCase() == 'paid' ? Icons.check_circle : Icons.warning_amber;
  }

  // Helper method to get profile image or initials
